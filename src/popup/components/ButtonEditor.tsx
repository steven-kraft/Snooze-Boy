    ...
    return (
      <Popout options={options} html="<div/>" onClose={this.props.onClose}>
        ...
        <div id="button-editor">
          <a href="#" className="save-button" onClick={this.save}>
          ...
          <div className="test">
            ...
            <input className="snooze-label-edit" type="text" placeholder="Custom Snooze Button" name="label"/>
          </div>
          <div className="radio-section" id="time-select">
            <input type="radio" name="type" value="time" checked={true} />
            <select>
          ...
          <div className="radio-section" id="interval-select">
